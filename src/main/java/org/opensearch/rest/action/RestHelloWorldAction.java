...
public class RestHelloWorldAction extends BaseRestHandler {
    ...
    private static HelloWorldService serviceImpl = ServiceLoader.load(HelloWorldService.class).iterator().next();
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> {
            try {
                channel.sendResponse(serviceImpl.buildResponse(name));
